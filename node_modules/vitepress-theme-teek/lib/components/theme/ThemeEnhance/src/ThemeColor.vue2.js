...
var _sfc_main = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    ...
    const {
      ...
      updateSpread
    } = useThemeColor.useThemeColor(primaryColor, () => {
    ...
    const update = (val) => {
      ...
      if (el.getAttribute(themeEnhance.themeColorAttribute) === val && primaryColor.value) return;
    ...
    Vue.watch(isDark, updateThemeColor);
    Vue.watch(
