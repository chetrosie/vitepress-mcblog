...
var _sfc_main = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    ...
    const docMaxWidth = useStorage.useStorage(
      namespace.docMaxWidthSlideStorageKey,
    ...
    const updateMaxWidth = (val) => {
      ...
      if (!shouldActivateMaxWidth.value) bodyStyle.setProperty(namespace.ns.join("page-max-width"), `100%`);
      bodyStyle.setProperty(namespace.docMaxWidthVar, `${Math.ceil(val / 100)}%`);
    };
    ...
    const update = useDebounce.useDebounce(updateMaxWidth, 1e3);
      ...
      return Vue.openBlock(), Vue.createBlock(Vue.Transition, {
        ...
        default: Vue.withCtx(() => [
          Vue.withDirectives(Vue.createVNode(BaseTemplate_vue_vue_type_script_setup_true_name_BaseTemplate_lang.default, {
            ...
            [Vue.vShow, Vue.unref(layoutMode) === Vue.unref(themeEnhance.LayoutMode).BothWidthAdjustable]
          ])
        ]),
        _: 1
        /* STABLE */
