...
var _sfc_main = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    ...
    const createDate = Vue.computed(() => {
      ...
      return index$1.formatDate(date || /* @__PURE__ */ new Date(), dateFormatConst, articleConfig.value.dateUTC);
    });
    const updateDate = Vue.computed(() => {
      ...
      const dateFormatConst = articleConfig.value.dateFormat;
      if (index$1.isFunction(dateFormatConst)) return dateFormatConst(date);
      return index$1.formatDate(date, dateFormatConst, !articleConfig.value.dateUTC);
    });
